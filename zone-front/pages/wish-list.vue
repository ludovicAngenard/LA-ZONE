    ...
    <v-row width="70%" class="mr-4">
      <v-col sm="12">
        <div
          ...
          draggable
          @dragstart="startDrag($event, whish)"
        >
          <v-img :src="whish.images[0]" max-width="500px" class="mr-4"> </v-img>
          <div class="d-flex flex-column justify-center">
            <a href="product" class="text-decoration-none">
              <h2 class="py-1 white--text">
                {{ whish.brand }}
              </h2>
            </a>
            <h3 class="py-1">
            ...
            <h4 class="py-1 red--text">{{ whish.price }} €</h4>
          </div>
        </div>
      </v-col>
    </v-row>
